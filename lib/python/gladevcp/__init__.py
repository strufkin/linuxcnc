...
if support_aux_apps:
    ...
    p,e = s.communicate()
    #print(type(p.decode()))
    gladevcp_aux_apps_dir = p.decode().strip() # remove trailing \n
    for auxdir in glob.glob(gladevcp_aux_apps_dir + "/*"):
        print("gladevcp: auxiliary dir:".format(auxdir))
