...
class Gremlin(Gtk.GLArea,Gtk.DrawingArea,rs274.glcanon.GlCanonDraw,glnav.GlNavBase):
...
#class Gremlin(gtk.gtkgl.widget.DrawingArea,glnav.GlNavBase,rs274.glcanon.GlCanonDraw):
 #   rotation_vectors = [(1.,0.,0.), (0., 0., 1.)]
    ...
    #    gtk.gtkgl.widget.DrawingArea.__init__(self, glconfig)
        ...
        self.connect('render', self.expose)
        ...
        #glutInitDisplayMode(GLUT_RGB | GLUT_DOUBLE | GLUT_DEPTH | GLUT_MULTISAMPLE | GLUT_ALPHA | GLUT_ACCUM)
    ...
    def activate(self):
        ...
        ctx.make_current()
        print("get_context() ", self.get_context())
        print("dir get_context() ", self.get_context().props.display)
        print("dir get_context() ", self.get_context().props.window)
        print("glArea get_error from activate",self.get_error())
        #glBegin()
        #Gdk.GLContext.
        #Gtk.
        #gl_area = Gtk.GLArea
    ...
    def deactivate(self):
        ...
        #gldrawable.gl_end()
        #glEnd()
        self.get_context().clear_current()
        return True
    ...
    def expose(self, widget=None, event=None):
        ...
        print("Initalizeddddd---------->\n\n\n\n")
        if self.perspective: self.redraw_perspective()
        else: self.redraw_ortho()
        print("post expose glGetError()",glGetError())
        print("GLArea error", self.get_error())
        return True
    ...
    def realize(self, widget):
        ...
        widget.make_current()
        #glutSetWindow(self.get_context().get_window())
        ...
        print("get_error fron __init__",self.get_error())
