...
try:
    ...
    def try_set_pin(p, v):
        try:
            ...
            print ("set {} {} fail".format( p.get_name(), v))
    ...
    def pin_validate(i, t, d):
        print ("pincheck {} {} {} {}".format( i.get_name(), i.is_pin(), i.get_type() == t, i.get_dir() == d))
    ...
    import traceback
    raise Exception("Exception: {}".format( traceback.format_exc()))
finally:
    h.exit()
EOF
realtime stop
